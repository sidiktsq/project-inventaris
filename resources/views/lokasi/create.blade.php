    ...
    <div class="premium-header">
        <div class="d-flex align-items-center">
            <div class="icon-box me-3" style="background: rgba(255,255,255,0.2); padding: 12px; border-radius: 15px;">
                <i class="bx bx-plus-circle text-white fs-2"></i>
            </div>
            <div>
                <h2 class="fw-bold text-white mb-0">Tambah Lokasi Baru</h2>
                <p class="text-white-50 mb-0">Master Data / Lokasi Penyimpanan</p>
            </div>
        </div>
    </div>
    ...
    <div class="content-overlay">
        <div class="card main-card">
            <div class="card-header-premium d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold"><i class="bx bx-map-pin me-2 text-success"></i>Detail Informasi Lokasi</h5>
                <span class="badge bg-label-success rounded-pill">Data Baru</span>
            </div>
                ...
                <form action="{{ route('lokasi.store') }}" method="POST">
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="nama" id="nama" 
                                    ...
                                    placeholder="Contoh: Gudang Utama, Perpustakaan, Ruang Lab" 
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4"
                                    ...
                                    placeholder="Jelaskan detail posisi atau fungsi lokasi ini...">{{ old('deskripsi') }}</textarea>
                            </div>
                            @error('deskripsi')
                                <small class="text-danger mt-1 d-block">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-4">
                        ...
                        <button type="submit" class="btn btn-save">
                            <i class="bx bx-check-shield me-1"></i> Simpan Lokasi
                        </button>
                    </div>
                </form>
            </div>
